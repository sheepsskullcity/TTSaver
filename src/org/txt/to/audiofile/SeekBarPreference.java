...
public class SeekBarPreference extends DialogPreference implements OnSeekBarChangeListener {
    ...
    protected View onCreateDialogView() {
    	...
    	((TextView) view.findViewById(R.id.min_value)).setText(mMinValue + "%");
    	((TextView) view.findViewById(R.id.max_value)).setText(mMaxValue + "%");
    	...
    	mValueText.setText(mCurrentValue + "%");
