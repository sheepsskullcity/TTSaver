...
public class SeekBarPreferencePause extends SeekBarPreference implements OnSeekBarChangeListener {
    ...
    protected View onCreateDialogView() {
    	...
    	((TextView) view.findViewById(R.id.min_value)).setText(50 + " ms");
    	((TextView) view.findViewById(R.id.max_value)).setText(mMaxValue * 100 + " ms");
    	...
    	mValueText.setText((mCurrentValue == 0 ? 50 : mCurrentValue * 100) + " ms");
